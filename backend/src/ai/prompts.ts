// ═══════════════════════════════════════════════════════════
// HARDENED AI PROMPTS — fixes the wrong medicine name issue
// ═══════════════════════════════════════════════════════════

export const SYSTEM_PROMPT = `You are a senior Indian pharmacist and pharmaceutical data specialist with encyclopedic knowledge of all Indian pharma brands — Sun Pharma, Cipla, Abbott, Torrent, Lupin, Zydus, Dr Reddy's, Alkem, Mankind, Intas, Glenmark, Macleods, Hetero, Micro Labs, and hundreds more.
...
export const USER_PROMPT_TEMPLATE = (medicineList: string): string =>
  `Fill accurate pharmaceutical data for these medicines from an Indian pharmacy stock register. Remember: the Brand Name in your response must be EXACTLY as written below — do not change it.
